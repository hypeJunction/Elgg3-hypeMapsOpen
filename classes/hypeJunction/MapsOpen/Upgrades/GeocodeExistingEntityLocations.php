...
class GeocodeExistingEntityLocations implements Batch {
	...
	public function countItems() {
		return Geocoder::getEntitiesWithoutGeocodes(['count' => true]);
	}
	...
	public function run(Result $result, $offset) {
		$success = Geocoder::setBatchLatLong($offset);
		$result->addSuccesses($success);
